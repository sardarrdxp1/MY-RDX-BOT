...
module.exports.run = async ({ event, api, Users, Threads, args }) => {
  ...
  var mangG = "Kashif Raza";
  if(credit != mangG) return api.sendMessage(formatMessage(`Sai credit!`), event.threadID, event.messageID);
    ...
    case 'ad':
      {
        ...
        api.sendMessage(formatMessage("𝗠𝗢𝗗𝗘 - Unbanned for all Admin Bot"), threadID, messageID)
        break;
      }
    ...
    case 'ndh':
      {
        ...
        api.sendMessage(formatMessage("𝗠𝗢𝗗𝗘 - Unbanned for all Supporters"), threadID, messageID)
        break;
      }
    ...
    case 'allthread':
      {
        ...
        api.sendMessage(formatMessage("𝗠𝗢𝗗𝗘 - Unbanned for the entire group on the server"), threadID, messageID)
        break;
      }
    ...
    case 'thread':
      {
        ...
        api.sendMessage(formatMessage("𝗠𝗢𝗗𝗘 - The ban has been removed for this group"), threadID, messageID)
        break;
      }
    ...
    case 'alluser':
      {
        ...
        api.sendMessage(formatMessage("𝗠𝗢𝗗𝗘 - Unbanned for all users on the server"), threadID, messageID)
        break;
      }
    ...
    case 'allqtv':
      {
        ...
        api.sendMessage(formatMessage('𝗠𝗢𝗗𝗘- Unbanned for all Administrators on the server'), threadID, messageID);
        break;
      }
    ...
    case 'Qtv':
      {
        ...
        api.sendMessage(formatMessage("𝗠𝗢𝗗𝗘 - Unbanned for all Admins of this group"), threadID, messageID)
        break;
      }
    ...
    case 'user':
      {
        if (!args[1]) {
         // var threadInfo = await api.getThreadInfo(event.threadID);
          ...
          return api.sendMessage(formatMessage("𝗠𝗢𝗗𝗘 - Unbanned for all members of this group"), threadID, messageID);
        }
